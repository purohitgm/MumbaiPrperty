...
st.caption("Live NSE + 30-day Historical RRG + TradingView Candles + Telegram Alerts")
...
    fig.update_layout(height=520, xaxis_title="Relative Strength (30d)", yaxis_title="Momentum (30d)")
...
        st.download_button("Download", screening_data.to_csv(index=False), "screened.csv")


# ====================== TELEGRAM ALERTS ======================
st.sidebar.subheader("🛎️ Telegram Alerts")
token = st.sidebar.text_input("Bot Token", type="password")
chat_id = st.sidebar.text_input("Your Chat ID")
...
st.divider()
st.caption("v2 • Fully live data • Cleaned & ready")
